...
import {
  ...
  List, ListOrdered, Image, Table, Undo, Redo, Heading1, Heading2, Heading3,
} from "lucide-react";
...
export function Toolbar({ onToggleSidebar }: ToolbarProps) {
  return (
    <div className="flex items-center gap-1 border-b border-border px-4 py-2 dark:border-border-dark">
      ...
      <div className="mx-2 h-6 w-px bg-border dark:bg-border-dark" />
      <div className="flex items-center gap-1">
        <Button variant="ghost" size="icon"><Heading1 className="h-4 w-4" /></Button>
        <Button variant="ghost" size="icon"><Heading2 className="h-4 w-4" /></Button>
        <Button variant="ghost" size="icon"><Heading3 className="h-4 w-4" /></Button>
      </div>
      <div className="mx-2 h-6 w-px bg-border dark:bg-border-dark" />
      <div className="flex items-center gap-1">
      ...
      <div className="flex items-center gap-1">
        ...
        <Button variant="ghost" size="icon"><Table className="h-4 w-4" /></Button>
      </div>
      <div className="ml-auto">
        <Button variant="ghost" size="sm" onClick={onToggleSidebar}>AI</Button>
      </div>
    </div>
  );
}
